...
def get_circular_patch(name="", type=1, dx=0.25):
    ...
    pa.constants['K'] = stress_funcs.get_K(pa.constants['G'],
                                           pa.constants['nu'])
...
class StressSolver(Solver):
    def __init__(self, dim, integrator_type, xsph=0.5, marts_eps=0.3,
                 marts_n=4, CFL=None, martv_alpha=1.0, martv_beta=1.0):
        ''' constructor
    ...
    def initialize(self):
        ...
        self.print_properties.extend(['MArtStress02', 'MArtStress12',
                                      'MArtStress22'])
